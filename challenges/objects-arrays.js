...
*/
const animalNames = [];
zooAnimals.forEach(animal => lowCaseAnimalNames.push()
...
let lowerPopulationAnimals = [];
zooAnimals.filter(animal => lowerPopulation.push(animal.animal_name, animal.population < 5));
